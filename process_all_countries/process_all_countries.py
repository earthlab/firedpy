...
# e.g. ["spain", "portugal", "france"] or None
TEST_COUNTRIES = ["spain", "portugal", "france"]

# e.g. "v2025var"; if None, each country's name is used
PROJECT_NAME = "v2025var"
...
def main():
    ...
    for i, row in parameters.iterrows():
        ...
        run_name = PROJECT_NAME if PROJECT_NAME else country
         # Use common directory so we don't download the same thing twice
        directory = HOME.joinpath("all")
